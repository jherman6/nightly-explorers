...
export const readLearnSingContent: ContentBlock[] = [
  ...
  {
    type: "p",
    text: "Psychologist John Gottman's research on what he called \"emotion coaching\" found that parents who help children notice and name their feelings — rather than dismissing or minimizing them — tend to raise children with stronger emotional regulation and social skills. The mechanism is straightforward: a feeling that has a name is a feeling a child can think about, talk about, and eventually manage. A feeling with no name is just a wave that washes over them.",
  },
  {
    type: "p",
  ...
  {
    type: "p",
    text: "Music and language are processed by overlapping networks in the brain, which is part of why researchers like Aniruddh Patel have studied the connection between musical rhythm and the development of phonological awareness — the ability to hear and manipulate the sounds within words, a skill that strongly predicts later reading success. Singing slows language down, exaggerates its rhythm, and repeats it in a way that makes the sound structure of words easier for a young brain to notice.",
  },
  {
    type: "p",
