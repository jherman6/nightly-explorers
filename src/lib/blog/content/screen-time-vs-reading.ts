...
export const screenTimeVsReadingContent: ContentBlock[] = [
  ...
  {
    type: "p",
    text: "If you're looking for a structure that builds in that balance automatically, [The Nightly Explorers' nightly ritual](/) is built around exactly this: a few minutes of conversation, a small shared activity, and a short story — all designed to fit into the evening without requiring you to overhaul your routine.",
  },
