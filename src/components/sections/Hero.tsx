  ...
  return (
    ...
    >
      ...
      <div className="relative z-[5] mx-auto w-full max-w-container px-6 pb-[90px] pt-[146px]">
        ...
        <p className="mt-[22px] max-w-[540px] text-[clamp(16px,1.8vw,19px)] leading-relaxed text-moonbeam/82">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          ...
          <Link
            href="/#solution"
            className="inline-flex items-center justify-center gap-2.5 rounded-full border border-moonbeam/35 bg-moonbeam/5 px-7 py-3.5 text-[15.5px] font-bold text-moonbeam transition-all hover:bg-moonbeam/10 hover:border-moonbeam/60"
          >
            See How It Works
          </Link>
        </div>
      ...
      <div className="absolute bottom-[26px] left-1/2 z-[5] flex -translate-x-1/2 flex-col items-center gap-2 text-[12px] font-bold uppercase tracking-[0.12em] text-moonbeam/55">
        <span>Scroll</span>
        <span className="h-[26px] w-px animate-cueGrow bg-moonbeam/45" />
      </div>
    </section>
  );
}
